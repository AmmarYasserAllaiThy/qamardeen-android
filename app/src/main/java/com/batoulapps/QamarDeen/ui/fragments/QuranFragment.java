...
public class QuranFragment extends QamarFragment
    ...
    private class QuranListAdapter extends QamarListAdapter {
         ...
         * @return QuranData representing the first row before this row with data, or a default
         * QuranData structure
         */
        ...
        /**
         * gets the row number of the first entry who is older than the current row and has data
         *
         * @param row the current row
        ...
        /**
         * gets the row number of the first entry who is newer than the current row and has data
         *
         * @param row the current row
         * @return the row number or null if none
         */
