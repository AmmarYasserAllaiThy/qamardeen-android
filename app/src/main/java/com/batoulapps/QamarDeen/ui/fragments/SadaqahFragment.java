...
public class SadaqahFragment extends QamarFragment {
    ...
    public static int[] SADAQAH_SELECTOR_IMAGES_OFF = new int[]{
            R.drawable.sadaqah_money_t,
            R.drawable.sadaqah_effort_t,
            R.drawable.sadaqah_food_t,
            R.drawable.sadaqah_cloth_t,
            R.drawable.sadaqah_smile_t,
            R.drawable.sadaqah_other_t
    };
    ...
    /**
     * AsyncTask that asynchronously gets prayer data from the database and updates the cursor
     * accordingly.
     */
    private class ReadSadaqahDataTask extends AsyncTask<Long, Void, Cursor> {
        ...
        protected Cursor doInBackground(Long... params) {
            ...
            QamarDeenActivity activity = (QamarDeenActivity) SadaqahFragment.this.getActivity();
        ...
        protected void onPostExecute(Cursor cursor) {
            if (cursor != null) {
                if (cursor.moveToFirst()) {
                    ...
                    if (!data.isEmpty()) ((SadaqahListAdapter) mListAdapter).addDayData(data);
                }
    ...
    private void popupSadaqahBox(View anchorView, int currentRow) {
        List<Integer> sel = ((SadaqahListAdapter) mListAdapter).getDataItem(currentRow);
        mPopupHelper.showMultipleChoicePopup(
                this,
                anchorView,
                currentRow,
                sel,
    ...
    private class WriteSadaqahDataTask extends AsyncTask<Object, Void, Boolean> {
        ...
        protected Boolean doInBackground(Object... params) {
            mSadaqat = new ArrayList<>();
            for (Object param : params) if (param instanceof Integer) mSadaqat.add((Integer) param);
        ...
        protected void onPostExecute(Boolean result) {
            if (result != null && result) {
                ...
                ((SadaqahListAdapter) mListAdapter).addOneSadaqahData(localTimestamp, mSadaqat);
    ...
    private class SadaqahListAdapter extends QamarListAdapter {
        private Map<Long, List<Integer>> mDataMap = new HashMap<>();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                h.sadaqahWidget = convertView.findViewById(R.id.sadaqah_widget);
            ...
            holder.sadaqahWidget.setOnClickListener(view -> {
                scrollListToPosition(mListView, currentRow, mHeaderHeight);
                final View v = view;
                view.postDelayed(() -> popupSadaqahBox(v, currentRow), 50);
            });
        ...
        public void configurePinnedHeader(View v, int position, int alpha) {
            ...
            if (alpha == 255) {
                TextView hdr = v.findViewById(R.id.sadaqah_header_txt);
