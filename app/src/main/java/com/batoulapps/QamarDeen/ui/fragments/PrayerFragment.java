...
public class PrayerFragment extends QamarFragment {
    ...
    /**
     * these are strictly used for the selector (which uses a different order than the corresponding
     * values order).  as a result, we do not use PrayerBoxesLayout.SALAH_IMAGE_VALUES_X here.
     */
    ...
    public void onResume() {
        ...
        if (currentlyIsMale != mIsGenderMale || currentlyIsExtendedMode != mIsExtendedMode) {
            ...
            PrayerBoxesHeaderLayout boxes = headerView.findViewById(R.id.prayer_header_boxes);
            if (boxes != null) boxes.setExtendedMode(mIsExtendedMode);
        }
    }
    ...
    private class PrayerListAdapter extends QamarListAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                h.boxes = convertView.findViewById(R.id.prayer_boxes);
                h.headerBoxes = convertView.findViewById(R.id.prayer_header_boxes);
            ...
            holder.boxes.setSalahClickListener((view, salah) -> {
                ...
                final View v = view;
                view.postDelayed(() -> popupSalahBox(v, currentRow, salah), 50);
            });
