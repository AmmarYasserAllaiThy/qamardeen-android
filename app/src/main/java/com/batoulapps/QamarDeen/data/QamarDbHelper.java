...
public class QamarDbHelper extends SQLiteOpenHelper {
    ...
    private static final String PRAYERS_TABLE_DEF = "create table prayers(" +
    ...
    private static final String CHARITY_TABLE_DEF = "create table charity(" +
            "_id integer primary key autoincrement, " +
            "ts timestamp not null, " +
            "sadaqah_type integer not null, " +
            "unique(ts, sadaqah_type));";

    private static final String QURAN_TABLE_DEF = "create table readings(" +
            "_id integer primary key autoincrement, " +
            "ts timestamp not null, " +
    ...
    private static final String QURAN_INDEX = "create index quran_index on readings(ts);";

    private static final String FASTING_TABLE_DEF = "create table fasting(" +
            "_id integer primary key autoincrement, " +
            "ts timestamp not null, " +
